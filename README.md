...
RDBMS is an acronym for relational database and it is a way of storing data through relationships.  All tables and columns can be related to eachother. SQL is based on RDBMS and is a language used to control many different types of databases.
1. Why do tables need a `primary key`?
A primary key is the key used to help define each row of the database.  Every table should have a primary key.
1. What is the name given to a table column that references the primary key on another table.
foreign key
1. What do we need in order to have a _many to many_ relationship between two tables.
A third table sometimes called a bridge table.
