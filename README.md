...
Answer: SQL is a way to interact with the database and Relational Databases are one type of database.

- [ ] Why do tables need a `primary key`?

Answer: Primary keys are needed t0 be able to identiy each row of a table.
...
Answer: When more than one row references multiple rows from another table.
