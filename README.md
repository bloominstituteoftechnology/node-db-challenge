...
SQL is used to access and manipulate data within a relational database, whereas the software holding the data is the relational database.

- [ ] Why do tables need a `primary key`?

Primary keys uniquely identify and distinguish data units within the database.

- [ ] What is the name given to a table column that references the primary key on another table.

Foreign keys are used to reference another table.

- [ ] What do we need in order to have a _many to many_ relationship between two tables.

An associative table is used.
