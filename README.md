...
-   [ ] Explain the difference between `Relational Databases` and `SQL`.
    A realtion database is a data storage base that actually holds the data. SQL is used to query data from a database.
-   [ ] Why do tables need a `primary key`?
    Tables need a primary key in order to be able to be uniquely identified

-   [ ] What is the name given to a table column that references the primary key on another table.
    A foreign key
-   [ ] What do we need in order to have a _many to many_ relationship between two tables.
    We need to have a new table of foreign keys to keep data integrity and relatiosnhips.
