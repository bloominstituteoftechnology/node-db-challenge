...
rdbms is a relational database managment system while sql is the language used to interact between the two
...
1. What do we need in order to have a _many to many_ relationship between two tables.
  another table that has many/ multiple relationships
