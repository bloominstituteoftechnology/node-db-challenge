...
Relational Databases is the software that manages everything releated to data.
SQL is a language used to query in Relational Databases

- [ ] Why do tables need a `primary key`?
To uniquely identify rows in certain tables

- [ ] What is the name given to a table column that references the primary key on another table.
Foreign Key

- [ ] What do we need in order to have a _many to many_ relationship between two tables.
Two tables. A third table links the info between the tables and one can add additional rows
