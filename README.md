...
"Relational database management system" refers to the db software itself and SQL is one of the many languges used to interact with the system.
1. Why do tables need a `primary key`?
A primary key is a unique identifier for a specific record in the table.
1. What is the name given to a table column that references the primary key on another table.
Foreign key
1. What do we need in order to have a _many to many_ relationship between two tables.
we need to create a third table in between their relationship.
## Project Set Up
