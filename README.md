...
1. Explain the difference between `RDBMS` and `SQL`.
  ...
  Relational Database Managment Systems are systems used to store information where as Structured Query Language is the language that is used to interact with the system.
