...
* Relational Databases is the technology used to save and retrieve data.
* Structured Query Language is the language needed to communicate with Relational Databases. 

- [X] Why do tables need a `primary key`?

In order to identify each entry into the database, it gives them a unique identifier.
...
You could use: The Bridge Table, The Boolean Column, or the Multiple Column Method.
