...
RDMBS is the software, its the management system, and SQL is the language we use to interact with the system.

1. Why do tables need a `primary key`?

Primary key is the unique value that indentifies a column, 2 columns can't have the same primary key.
