...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
  ~  RDB is the software or system itself which manages, storage, querying and updating data. SQL is the language used to interact with the system

- [ ] Why do tables need a `primary key`?
  ~    Tables need primary keys as a way to uniquely identify each entry in the database.
