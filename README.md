...
SQL is a programming language used to make relational databases.

1. Why do tables need a `primary key`?

Data Normalization. It makes it so the rows within the table are uniquely identifiable.
...
An intermediary table that references both of the other tables.
