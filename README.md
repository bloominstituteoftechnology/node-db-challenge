...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
      The RDBMS is the software that manages everything related to data, whereas SQL is a language used to query the RDBMS.
- [ ] Why do tables need a `primary key`?
      In order to uniquely identify rows in a certain table
- [ ] What is the name given to a table column that references the primary key on another table.
      A foreign key
- [ ] What do we need in order to have a _many to many_ relationship between two tables.
      Each of the said two tables needs to have a many to one relationship. The two tables, then can be said to have a many to many relationship. A third table is often used to link the information that is shared between the two and one can add additional rows that reflect an outcome of the two tables interacting. 
