...
RDBMS is the database software that manages storage, querying, updating, etc. SQL is the language used to do that.
1. Why do tables need a `primary key`?
to deny any copies withing a column and/or row.
