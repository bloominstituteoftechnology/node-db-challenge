...
RDBMS is the relational database management system which carries out many functions including storage, updating, managing, querying. SQL is the language that facilitates many of the functions.

1. Why do tables need a `primary key`?

A primary key is a unique identifier for a specific record in the table
...
In a many to many relationship between two tables, we need to create a third table in between their relationship
