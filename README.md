...
Relational databases are the data in database tables whereas sql is a language to build with and not the same as sqlite3.
- [ ] Why do tables need a `primary key`?
For unique identification.
- [ ] What is the name given to a table column that references the primary key on another table.
Foreign keys are used to connect tables together with unique identifiers.
- [ ] What do we need in order to have a _many to many_ relationship between two tables.
Many to many are intermediaries or middlemen in the schema.
