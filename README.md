...
- [1] Explain the difference between `Relational Databases` and `SQL`.
      ...
      A relational db gives users the ability to manage pre-defined data relationships across databases.  SQL is the language that enables your db servers to query, edit and store the data.

- [2] Why do tables need a `primary key`?

      Primary keys are there to keep duplicates from being created and this also facilitates the linking of databases with the use of foreign keys.
...
- [4] What do we need in order to have a _many to many_ relationship between two tables.
    ...
    You need another table of a few more... more than just the original 2.
