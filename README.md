...
- RDBMS is the basis for SQL, and for all modern database systems. SQL is a database computer language designed for the retrieval and management of data in a relational database.

1. Why do tables need a `primary key`?

- It is the main identifier of records in a table.
...
- Another table with multiple relationships
