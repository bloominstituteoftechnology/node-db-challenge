  ...
  return knex('action').del()
    .then(function () {
      ...
      return knex('action').insert([
        { id: 1, action_description: 'Set up boilerplate fpr project', notes: 'This involves creating all files needed for the project and installing all packages', complete: true, project_id: 1 },
