  ...
  return knex('p_r').truncate()
    ...
    .then(() => {
      return knex('projects').insert([
        {id: 1, name: "Build Table",description: "Table will be built as a coffee table for the living room"},
        {id: 2, name: "Paint Portrait",description: "Used for decorating the living room"},
        {id: 3, name: "Plan Birthday Party",description: "1st birthday for Annie!"}
      ])
    })
    .then(()=> {
      return knex('resources').insert([
        {id: 1, name: "Wood", description: "oak wood or red wood"},
        ...
        {id: 4, name: "Canvas", description: "12 by 12 canvas"},
        {id: 5, name: "Baloons", description: "Pink balloons that have cats displayed"},
        {id: 6, name: "cake decorations", description: "Cat animal decor"}
      ])
    })
    .then(()=> {
